// ─── Types ───────────────────────────────────────────────────────
export type UserRole = "Admin" | "teacher" | "student" | "parent" | "finance" | "secretary";
...
export interface AdmissionApplication {
  ...
  parentPhone: string;
  parentEmail: string;
  status: "applied" | "review" | "interview" | "pending" | "approved";
  progress: number;
  date: string;
  id_number?: string;
}
...
export const students: Student[] = [
  { id: "S001", name: "Kevin Kamau", age: 14, address: "12 Riverside Dr", phone: "0700001001", email: "kevin.k@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026001", grade: "Form 1", section: "East", parentId: "P001", enrolledCourses: ["C001", "C002", "C003", "C004"], feeBalance: 15000, feePaid: 35000 },
  { id: "S002", name: "Sxx~haron Kamau", age: 16, address: "12 Riverside Dr", phone: "0700001002", email: "sharon.k@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026002", grade: "Form 3", section: "East", parentId: "P001", enrolledCourses: ["C001", "C003", "C005", "C010"], feeBalance: 5000, feePaid: 45000 },
  { id: "S003", name: "Brian Wanjiru", age: 15, address: "34 Lavington Rd", phone: "0700002001", email: "brian.w@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026003", grade: "Form 2", section: "West", parentId: "P002", enrolledCourses: ["C001", "C002", "C006"], feeBalance: 20000, feePaid: 30000 },
  { id: "S004", name: "Mercy Odera", age: 14, address: "56 Kilimani Rd", phone: "0700003001", email: "mercy.o@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026004", grade: "Form 1", section: "West", parentId: "P003", enrolledCourses: ["C001", "C002", "C003", "C011"], feeBalance: 0, feePaid: 50000 },
  { id: "S005", name: "Alex Odera", age: 17, address: "56 Kilimani Rd", phone: "0700003002", email: "alex.o@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026005", grade: "Form 4", section: "East", parentId: "P003", enrolledCourses: ["C001", "C003", "C005", "C007"], feeBalance: 10000, feePaid: 40000 },
  { id: "S006", name: "Grace Muthoni", age: 15, address: "78 Hurlingham Rd", phone: "0700004001", email: "grace.m@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026006", grade: "Form 2", section: "East", parentId: "P004", enrolledCourses: ["C001", "C002", "C004", "C012"], feeBalance: 8000, feePaid: 42000 },
  { id: "S007", name: "Dennis Kipchoge", age: 14, address: "90 Westlands Rd", phone: "0700005001", email: "dennis.k@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026007", grade: "Form 1", section: "North", parentId: "P005", enrolledCourses: ["C001", "C002", "C003"], feeBalance: 25000, feePaid: 25000 },
  { id: "S008", name: "Faith Kipchoge", age: 16, address: "90 Westlands Rd", phone: "0700005002", email: "faith.k@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026008", grade: "Form 3", section: "West", parentId: "P005", enrolledCourses: ["C001", "C005", "C006", "C010"], feeBalance: 12000, feePaid: 38000 },
  { id: "S009", name: "Victor Chebet", age: 15, address: "11 Parklands Rd", phone: "0700006001", email: "victor.c@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026009", grade: "Form 2", section: "North", parentId: "P006", enrolledCourses: ["C001", "C002", "C007"], feeBalance: 18000, feePaid: 32000 },
  { id: "S010", name: "Diana Wafula", age: 17, address: "22 Muthaiga Rd", phone: "0700007001", email: "diana.w@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026010", grade: "Form 4", section: "West", parentId: "P007", enrolledCourses: ["C001", "C003", "C005", "C008"], feeBalance: 3000, feePaid: 47000 },
  { id: "S011", name: "Martin Wafula", age: 14, address: "22 Muthaiga Rd", phone: "0700007002", email: "martin.w@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026011", grade: "Form 1", section: "East", parentId: "P007", enrolledCourses: ["C001", "C002", "C003", "C011"], feeBalance: 30000, feePaid: 20000 },
  { id: "S012", name: "Esther Nyambura", age: 16, address: "33 Runda Rd", phone: "0700008001", email: "esther.n@student.com", schoolCode: "AKHUB001", admissionNo: "ADM2026012", grade: "Form 3", section: "North", parentId: "P008", enrolledCourses: ["C001", "C003", "C006", "C012"], feeBalance: 7000, feePaid: 43000 },
];
...
export const academicCalendar: CalendarEvent[] = [
  { id: "EV001", title: "Term 1 Opening", description: "All students report back", date: "2026-01-05", type: "academic", createdBy: "U001" },
  { id: "EV002", title: "Mid-Term Break", description: "Mid-term recess", date: "2026-02-15", type: "holiday", createdBy: "U001" },
  { id: "EV003", title: "Sports Day", description: "Annual inter-house sports", date: "2026-03-10", type: "event", createdBy: "U001" },
  { id: "EV004", title: "Final Exams", description: "End of Term 1 Exams", date: "2026-04-20", type: "exam", createdBy: "U001" },
];

export const assignments: Assignment[] = [
  { id: "ASG001", courseId: "C001", title: "Algebra Worksheet 1", description: "Solve quadratic equations", dueDate: "2026-04-15", totalMarks: 20, teacherId: "T001", status: "active" },
  { id: "ASG002", courseId: "C001", title: "Geometry Assignment", description: "Areas and volumes of 3D shapes", dueDate: "2026-04-20", totalMarks: 25, teacherId: "T001", status: "active" },
  { id: "ASG003", courseId: "C002", title: "Essay Writing", description: "Write a 500-word argumentative essay", dueDate: "2026-04-18", totalMarks: 30, teacherId: "T003", status: "active" },
  { id: "ASG004", courseId: "C003", title: "Physics Lab Report", description: "Ohm's law experiment report", dueDate: "2026-04-22", totalMarks: 20, teacherId: "T002", status: "active" },
  { id: "ASG005", courseId: "C010", title: "Build a Calculator", description: "Create a web calculator using JavaScript", dueDate: "2026-04-25", totalMarks: 40, teacherId: "T005", status: "active" },
  { id: "ASG006", courseId: "C007", title: "Cell Biology Diagram", description: "Draw and label animal and plant cells", dueDate: "2026-04-17", totalMarks: 15, teacherId: "T008", status: "active" },
];

export const studentAssignments: StudentAssignment[] = [
  { id: "SA001", assignmentId: "ASG001", studentId: "S001", status: "finished", isMarked: true, marksAwarded: 18, feedback: "Excellent work on quadratics" },
  { id: "SA002", assignmentId: "ASG002", studentId: "S001", status: "not-finished", isMarked: false },
  { id: "SA003", assignmentId: "ASG003", studentId: "S001", status: "finished", isMarked: false },
];
...
export const examResults: ExamResult[] = [
  { id: "ER001", examId: "EX001", studentId: "S001", marksObtained: 78, grade: "B+", remarks: "Good performance", status: "approved" },
  { id: "ER002", examId: "EX001", studentId: "S004", marksObtained: 92, grade: "A", remarks: "Excellent", status: "approved" },
  { id: "ER003", examId: "EX001", studentId: "S007", marksObtained: 65, grade: "B-", remarks: "Needs improvement", status: "approved" },
  { id: "ER004", examId: "EX001", studentId: "S011", marksObtained: 85, grade: "A-", remarks: "Very good", status: "approved" },
  { id: "ER005", examId: "EX002", studentId: "S001", marksObtained: 70, grade: "B", remarks: "Satisfactory", status: "approved" },
  { id: "ER006", examId: "EX003", studentId: "S003", marksObtained: 88, grade: "A-", remarks: "Excellent work", status: "approved" },
  { id: "ER007", examId: "EX003", studentId: "S006", marksObtained: 72, grade: "B", remarks: "Good effort", status: "approved" },
  { id: "ER008", examId: "EX003", studentId: "S009", marksObtained: 55, grade: "C+", remarks: "More practice needed", status: "approved" },
  { id: "ER009", examId: "EX004", studentId: "S002", marksObtained: 25, grade: "A-", remarks: "Great", status: "approved" },
  { id: "ER010", examId: "EX004", studentId: "S008", marksObtained: 22, grade: "B+", remarks: "Good", status: "approved" },
  { id: "ER011", examId: "EX004", studentId: "S012", marksObtained: 28, grade: "A", remarks: "Outstanding", status: "approved" },
  { id: "ER012", examId: "EX005", studentId: "S005", marksObtained: 27, grade: "A", remarks: "Excellent", status: "approved" },
  { id: "ER013", examId: "EX005", studentId: "S010", marksObtained: 20, grade: "B", remarks: "Satisfactory", status: "approved" },
  { id: "ER014", examId: "EX001", studentId: "S001", marksObtained: 85, grade: "A-", remarks: "Marking complete", status: "pending" },
];
...
export const admissionApplications: AdmissionApplication[] = [
  { id: "APP001", studentName: "John Doe Jr", grade: "Form 1", parentName: "John Doe", parentPhone: "0711000111", parentEmail: "john@doe.com", status: "applied", progress: 20, date: "2026-04-10" },
  { id: "APP002", studentName: "Alice Smith", grade: "Form 1", parentName: "Bob Smith", parentPhone: "0722000222", parentEmail: "bob@smith.com", status: "review", progress: 40, date: "2026-04-11" },
  { id: "APP003", studentName: "Michael Brown", grade: "Form 2", parentName: "Sarah Brown", parentPhone: "0733000333", parentEmail: "sarah@brown.com", status: "interview", progress: 60, date: "2026-04-12" },
  { id: "APP004", studentName: "Emma Wilson", grade: "Form 1", parentName: "David Wilson", parentPhone: "0744000444", parentEmail: "david@wilson.com", status: "pending", progress: 80, date: "2026-04-13" },
];

export const auditLogs: AuditLog[] = [
  { id: "LOG001", user: "Admin", action: "UPDATE", module: "Settings", time: "2026-04-14 09:00", details: "Changed school motto" },
  { id: "LOG002", user: "Finance Officer", action: "CREATE", module: "Finance", time: "2026-04-14 10:30", details: "Added new fee structure for Term 2" },
  { id: "LOG003", user: "Secretary", action: "UPDATE", module: "Admissions", time: "2026-04-14 11:15", details: "Approved application APP005" },
];

export const userAccounts: UserAccount[] = [
  { id: "U001", email: "Admin@school.com", password: "Admin123", role: "Admin", personId: "Admin", name: "System Admin", status: "active" },
  { id: "U002", email: "james@school.com", password: "teacher123", role: "teacher", personId: "T001", name: "Dr. James Mwangi", status: "active" },
  { id: "U003", email: "sarah@school.com", password: "teacher123", role: "teacher", personId: "T002", name: "Prof. Sarah Otieno", status: "active" },
  { id: "U004", email: "kevin.k@student.com", password: "student123", role: "student", personId: "S001", name: "Kevin Kamau", status: "active" },
  { id: "U005", email: "sharon.k@student.com", password: "student123", role: "student", personId: "S002", name: "Sharon Kamau", status: "active" },
  { id: "U006", email: "joseph.k@email.com", password: "parent123", role: "parent", personId: "P001", name: "Mr. Joseph Kamau", status: "active" },
  { id: "U007", email: "mary.w@email.com", password: "parent123", role: "parent", personId: "P002", name: "Mrs. Mary Wanjiru", status: "active" },
  { id: "U008", email: "finance@school.com", password: "finance123", role: "finance", personId: "F001", name: "Finance Officer", status: "active" },
  { id: "U009", email: "secretary@school.com", password: "secretary123", role: "secretary", personId: "S012", name: "School Secretary", status: "active" },
];
...
export const conversations: Conversation[] = [
  {
    id: "conv1",
    participantIds: ["Admin", "T001"],
    participantNames: ["Admin", "James Wilson"],
    participantRoles: ["Admin", "teacher"],
    lastMessageContent: "The attendance records have been updated for this morning.",
    lastMessageTime: "Today, 10:45 AM",
    unreadCount: 0
  },
  {
    id: "conv2",
    participantIds: ["S001", "T001"],
    participantNames: ["Kevin Kimani", "James Wilson"],
    participantRoles: ["student", "teacher"],
    lastMessageContent: "Thank you for the feedback on my Math assignment.",
    lastMessageTime: "Today, 09:12 AM",
    unreadCount: 1
  }
];
...
export const messages: ChatMessage[] = [
  {
    ...
    senderRole: "teacher",
    content: "The attendance records have been updated for this morning.",
    time: "Today, 10:45 AM",
    read: true
  },
  {
    ...
    senderName: "James Wilson",
    senderRole: "teacher",
    content: "Good job on the recent test, Kevin!",
    time: "Today, 09:05 AM",
    read: true
  },
  {
    ...
    conversationId: "conv2",
    senderId: "S001",
    senderName: "Kevin Kimani",
    senderRole: "student",
    content: "Thank you for the feedback on my Math assignment.",
    time: "Today, 09:12 AM",
    read: false
  }
];
...
export function getAllUsers() {
  const all = [
    { id: "Admin", name: "Administrator", role: "Admin" as UserRole, email: "Admin@school.com" },
    ...teachers.map(t => ({ id: t.id, name: t.name, role: "teacher" as UserRole, email: t.email })),
    ...students.map(s => ({ id: s.id, name: s.name, role: "student" as UserRole, email: s.email })),
    ...parents.map(p => ({ id: p.id, name: p.name, role: "parent" as UserRole, email: p.email })),
    // Staff would normally be here too
    { id: "F001", name: "Moses Finance", role: "finance" as UserRole, email: "moses@gmail.com" },
    { id: "SEC001", name: "Njoroge Secretary", role: "secretary" as UserRole, email: "njoroge@gmail.com" }
  ];
  return all;
}
...
export function getUserActivity(userId: string) {
  // Enhanced Mock activity for monitoring
  return [
    { id: 1, type: "Login", time: "2 hours ago", detail: "Logged in from Chrome (Nairobi, Kenya)", status: "Success" },
    { id: 2, type: "Security", time: "5 hours ago", detail: "Password changed via Admin Portal", status: "Neutral" },
    { id: 3, type: "Messaging", time: "7 hours ago", detail: "Started new conversation with James Wilson", status: "Info" },
    { id: 4, type: "Data Access", time: "Yesterday", detail: "Downloaded Term 1 Report Card", status: "Warning" },
    { id: 5, type: "Profile", time: "2 days ago", detail: "Updated emergency contact information", status: "Success" },
  ];
}
