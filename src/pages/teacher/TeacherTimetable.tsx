...
export default function TeacherTimetable() {
  ...
  const initialSlots = timetableSlots.filter(s => s.teacherId === teacher?.id);
  ...
  const handleSaveSlot = () => {
    if (!formData.classroomId || !formData.courseId) {
      alert("Please select both classroom and course");
      return;
    }
